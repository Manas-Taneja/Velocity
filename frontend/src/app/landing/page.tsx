...
export default function GritLanding() {
    return (
            ...
            <nav className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="font-bold text-white tracking-widest font-mono">GRIT</span>
                    </div>
                    <div className="flex items-center space-x-6 text-sm font-mono">
                        ...
                        <button className="text-slate-400 hover:text-white transition-colors">Login</button>
                        <button className="bg-white text-black hover:bg-slate-200 px-4 py-2 font-bold rounded transition-colors">
                            Hiring Manager?
                        </button>
                    </div>
                </div>
            ...
            <section className="relative pt-20 pb-32 px-6 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <button className="group relative px-8 py-4 bg-secondary hover:bg-secondary/90 text-white font-bold font-mono rounded overflow-hidden transition-all">
                            <span className="relative z-10 flex items-center">
                                START ASSESSMENT
                                <ChevronRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </span>
                        </button>
                        <button className="px-8 py-4 bg-transparent border border-slate-700 hover:border-slate-500 text-white font-mono rounded transition-all">
                            VIEW DEMO
                        </button>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8">
                        <FeatureCard
                            ...
                            desc="Real work isn't sorted arrays. It's 50MB CSVs with mixed delimiters, broken encodings, and dates formatted as text. We test for grit, not memory."
                        />
                        <FeatureCard
                            icon={Cpu}
                            title="The AI Trap"
                    ...
                    <div className="grid md:grid-cols-2 gap-0 border border-slate-800 rounded-xl overflow-hidden">
                        ...
                        <div className="bg-slate-900/80 p-8 relative">
                            ...
                            <div className="flex items-center space-x-2 mb-6">
                                ...
                                <h3 className="font-bold text-white uppercase tracking-widest">Grit Protocol</h3>
                            </div>
